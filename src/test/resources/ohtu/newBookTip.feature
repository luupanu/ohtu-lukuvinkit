Feature: User can add a new reading tip (Book)
  ...
  Scenario: When all fields are filled but Author is left empty and submit is clicked
    Given user is at the main page
    When type "Book" is selected in the form
    And form is filled with title "Sailing Alone Around the World" description "A book about sailing." author "" isbn "0-486-20326-3" tags "Sailing" and is submitted
  ...
  Scenario: When all fields are filled but ISBN is left empty and submit is clicked
    Given user is at the main page
    When type "Book" is selected in the form
    And form is filled with title "Sailing Alone Around the World" description "A book about sailing." author "Captain Joshua Slocum" isbn "" tags "Sailing" and is submitted
